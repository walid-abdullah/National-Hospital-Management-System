...
<head>
    ...
    <title>Appointments - Reception Desk</title>
...
<body class="bg-slate-50 text-slate-800 antialiased selection:bg-blue-200 selection:text-blue-900 flex flex-col min-h-screen transition-colors duration-300 dark:bg-gray-900 dark:text-gray-100">
    ...
    <div class="max-w-6xl mx-auto animate-fade-in-up p-6 mt-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Hospital Appointments</h2>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if(!empty($appointments)): ?>
                        ...
                        <tr class="hover:bg-blue-50 dark:hover:bg-slate-700 transition-colors duration-200">
                            ...
                            <td class="p-4 text-sm font-medium text-pink-600"><?php echo htmlspecialchars($apt['doctor_name']); ?></td>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="p-6 text-center text-gray-500 dark:text-gray-400">No appointments found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
