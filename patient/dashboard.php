...
<body class="bg-slate-50 text-slate-800 antialiased selection:bg-blue-200 selection:text-blue-900 flex flex-col min-h-screen transition-colors duration-300 dark:bg-gray-900 dark:text-gray-100">
    ...
    <div class="max-w-5xl mx-auto animate-fade-in-up mt-10">
        <div class="glass p-8 rounded-3xl shadow-2xl border border-white/50">
            <h2 class="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Patient Overview</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-indigo-50 dark:bg-slate-800 p-6 rounded-lg border border-indigo-100 dark:border-slate-700 text-center">
                    <h3 class="text-lg font-semibold text-indigo-800 dark:text-indigo-400">Medical History</h3>
                    <a href="records.php" class="inline-block mt-4 bg-indigo-600 text-white px-4 py-2 rounded shadow hover:bg-indigo-700 w-full transition">View Records</a>
                </div>
                <div class="bg-orange-50 dark:bg-slate-800 p-6 rounded-lg border border-orange-100 dark:border-slate-700 text-center">
                    <h3 class="text-lg font-semibold text-orange-800 dark:text-orange-400">Billing</h3>
                    <a href="billing.php" class="inline-block mt-4 bg-orange-600 text-white px-4 py-2 rounded shadow hover:bg-orange-700 w-full transition">View Bills</a>
                </div>
                <div class="bg-blue-50 dark:bg-slate-800 p-6 rounded-lg border border-blue-100 dark:border-slate-700 text-center">
                    <h3 class="text-lg font-semibold text-blue-800 dark:text-blue-400">Prescriptions</h3>
                    <a href="prescriptions.php" class="inline-block mt-4 bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700 w-full transition">View Medicines</a>
                </div>
                <div class="bg-purple-50 dark:bg-slate-800 p-6 rounded-lg border border-purple-100 dark:border-slate-700 text-center">
                    <h3 class="text-lg font-semibold text-purple-800 dark:text-purple-400">Lab Reports</h3>
                    <a href="lab_tests.php" class="inline-block mt-4 bg-purple-600 text-white px-4 py-2 rounded shadow hover:bg-purple-700 w-full transition">View Test Results</a>
                </div>
            </div>
        </div>
    </div>
