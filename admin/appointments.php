...
<head>
    ...
    <title>Manage Appointments - NHIMS</title>
                    ...
                    <?php if(!empty($appointments)): ?>
                        ...
                        <tr class="hover:bg-blue-50 dark:hover:bg-slate-700 transition-colors duration-200">
                            ...
                            <td class="p-4 text-center space-x-2">
                                <a href="edit_appointment.php?id=<?php echo $apt['appointment_id']; ?>" class="text-blue-500 hover:text-blue-700 font-medium text-sm">Edit</a>
