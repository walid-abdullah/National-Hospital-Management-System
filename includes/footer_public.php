        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="col-span-1">
                    <h3 class="text-gray-900 dark:text-white font-semibold mb-4 uppercase text-sm tracking-wider">Quick Links</h3>
                    <ul class="space-y-3">
                        <li><a href="index.php" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors text-sm">Home</a></li>
                        <li><a href="public_doctors.php" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors text-sm">Find a Doctor</a></li>
                        <li><a href="public_lab.php" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors text-sm">Lab Services</a></li>
                        <li><a href="book_online.php" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors text-sm">Book Appointment</a></li>
                        <li><a href="login.php" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors text-sm">Portal Login</a></li>
                    </ul>
                </div>

                <!-- Departments -->
                <div class="col-span-1">
                    <h3 class="text-gray-900 dark:text-white font-semibold mb-4 uppercase text-sm tracking-wider">Departments</h3>
                    <ul class="space-y-3">
                        <li><span class="text-gray-500 dark:text-gray-400 text-sm">Cardiology</span></li>
                        <li><span class="text-gray-500 dark:text-gray-400 text-sm">Neurology</span></li>
                        <li><span class="text-gray-500 dark:text-gray-400 text-sm">Orthopedics</span></li>
                        <li><span class="text-gray-500 dark:text-gray-400 text-sm">Pediatrics</span></li>
                        <li><span class="text-gray-500 dark:text-gray-400 text-sm">General Surgery</span></li>
                    </ul>
                </div>

                <!-- Contact -->
                <div class="col-span-1">
                    <h3 class="text-gray-900 dark:text-white font-semibold mb-4 uppercase text-sm tracking-wider">Contact Us</h3>
                    <ul class="space-y-3 text-sm text-gray-500 dark:text-gray-400">
                        <li class="flex items-start">
                            <svg class="h-5 w-5 mr-2 text-blue-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                            123 Health Avenue, Dhaka 1200, Bangladesh
                        </li>
